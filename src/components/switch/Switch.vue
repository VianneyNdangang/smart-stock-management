...
<template>
  ...
  >
    <span
      class="flex h-5 w-5 items-center justify-center rounded-full bg-white transition-transform duration-300 text-(--text-muted)"
      :class="model ? 'translate-x-8' : 'translate-x-1'"
    >
      <VueIcon
        v-if="props"
