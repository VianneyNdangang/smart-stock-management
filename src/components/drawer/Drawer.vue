    ...
    >
      ...
      >
        <aside
          ...
          :class="[
            props.placement === 'top'
              ? props.h? `top-0 left-0 w-full h=${props.h}`:'top-0 left-0 w-full h-1/3'
              : props.placement === 'bottom'
                ?props.h? `bottom-0 left-0 w-full h=${props.h}`: 'bottom-0 left-0 w-full h-1/3'
                : props.placement === 'start'
                  ?props.w?`left-0 top-0 h-full w-${props.w}`: 'left-0 top-0 h-full w-80'
